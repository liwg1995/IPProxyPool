...
<br/>
```
[["39.134.61.76", 80, 10,"国内","北京市 移动"], ["39.134.61.75", 80, 10,"国内","北京市 移动"], ... ]
```
<br/>
以["39.134.61.76", 80, 10,"国内","北京市 移动"]为例，第一个元素是ip,第二个元素是port，第三个元素是分值score,分值越小，代理效果越好，第四个是国内国外的区分，五个是地区。 
